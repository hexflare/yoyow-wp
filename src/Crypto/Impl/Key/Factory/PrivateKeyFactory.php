...
class PrivateKeyFactory
{
    ...
    {
        $ecAdapter = $ecAdapter ?: YOYOW::getEcAdapter();
        $this->privSerializer = new PrivateKeySerializer($ecAdapter);
     ...
     * @throws \Exception
     */
    public function fromWif(string $wif): PrivateKeyInterface
    {
        return $this->wifSerializer->parse($wif);
    }
}